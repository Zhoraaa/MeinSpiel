...
<form method="GET" class="inner-shadow radius" id="personal-area">
    ...
    <div id="info">
        <div><input name="newLogin" class="inner-shadow radius pad10" value="<?= $user['name_user'] ?>" placeholder="name"><a href="../account"><button type="button" class="radius white-border">Отмена</button></a></div>
